...
const gcrevoke = ["917736622139-1632933054@g.us"]
prefix = '#'
shp = '⬡'
...
console.log(color(figlet.textSync(`${spc1}            Pepe Bot`, {
font: 'Standard',
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('[DOGE BOT]'), color('𝗣𝗲𝗽𝗲 𝗕𝗼𝘁 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 😌', 'aqua'))
  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "Hello everyone, am PEPE SIR Bot😎, ready to help you here 🙂💖", "conversation");
      }
